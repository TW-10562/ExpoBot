    ...
    <div className="bg-surface dark:bg-dark-surface rounded-2xl w-full max-w-md border border-default shadow-2xl transition-colors overflow-hidden">
      ...
      <div className="flex items-center justify-between p-5 border-b border-default bg-surface-alt dark:bg-dark-bg-primary transition-colors">
        <div className="flex items-center gap-3">
          ...
          <h3 className="font-semibold text-foreground dark:text-white text-lg transition-colors">
            {title}
          </h3>
        </div>
        <button
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="space-y-3 text-sm text-muted dark:text-white/80 transition-colors">
          <p className="font-medium text-foreground dark:text-white transition-colors">
            {t('hrContact.title')}
          </p>

          <p>
            📧 {t('hrContact.email')}:{" "}
<span className="text-accent dark:!text-[#99FEFF]">
              hr@company.com
            </span>
          </p>
