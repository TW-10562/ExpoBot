          ...
          <>
            <div className="flex items-center justify-between p-5 border-b border-[#E8E8E8] dark:border-dark-border bg-[#F6F6F6] dark:bg-dark-bg-primary transition-colors">
              <div className="flex items-center gap-3">
                <div className="p-2.5 bg-[#1d2089] dark:bg-gradient-to-r dark:from-[#60a5fa] dark:to-[#a78bfa] rounded-xl transition-colors">
            ...
            <div className="p-5 space-y-4">
              ...
              <button
                ...
                className="w-full bg-[#1d2089] hover:bg-[#161870] disabled:bg-[#E8E8E8] disabled:text-[#9CA3AF] dark:bg-gradient-to-r dark:from-[#60a5fa] dark:to-[#a78bfa] dark:hover:from-[#7ab8ff] dark:hover:to-[#b89cff] dark:disabled:from-[#60a5fa]/50 dark:disabled:to-[#a78bfa]/50 text-white font-medium py-3 px-4 rounded-xl flex items-center justify-center gap-2 transition-all"
              >
